...
use wasm_encoder::{ComponentTypeRef, FuncType};
...
impl Compiler {
    pub fn declare_event(
        ...
        let func = to_kebab_case(event_name.as_str());
        ...
        let func_idx = self.import_function(&interface, &func, core_fn_ty);
        ...
        let comp_fn_ty = iface.encode_func(comp_params.into_iter(), comp_result.as_ref());
        iface
            .inner
            .export(&func, ComponentTypeRef::Func(comp_fn_ty));
