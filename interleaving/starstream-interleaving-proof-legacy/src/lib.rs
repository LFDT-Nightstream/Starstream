...
/// Default number of interleaving sub-steps folded as one R1CS instance.
///
/// The batch size is a proving-time performance knob; verification derives its
/// preprocessing from the R1CS shape carried by the proof.
