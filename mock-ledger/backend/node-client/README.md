...
2. `implicit_static_call` for interacting with UTXOs in the ledger implicitly through Wasm components, where the interface for the component is statically known (ex: comes for wit_bindgen)
